...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile14, function (sprite, location) {
    if (inTeleporting == 0) {
        tiles.placeOnRandomTile(sprite, myTiles.tile13)
        inTeleporting = 1
...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile15, function (sprite, location) {
    if (inTeleporting == 0) {
        tiles.placeOnRandomTile(sprite, myTiles.tile12)
        inTeleporting = 1
        timer.after(500, function () {
            inTeleporting = 0
        })
...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile12, function (sprite, location) {
    if (inTeleporting == 0) {
        tiles.placeOnRandomTile(sprite, myTiles.tile15)
        inTeleporting = 1
        timer.after(500, function () {
            inTeleporting = 0
        })
...
scene.onOverlapTile(SpriteKind.Player, myTiles.tile13, function (sprite, location) {
    if (inTeleporting == 0) {
        tiles.placeOnRandomTile(sprite, myTiles.tile14)
        inTeleporting = 1
        timer.after(500, function () {
            inTeleporting = 0
        })
